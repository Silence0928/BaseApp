...
import com.lib_common.view.layout.dialog.update.action.ClickAction;
import com.lib_common.view.layout.dialog.update.action.ContextAction;
import com.lib_common.view.layout.dialog.update.action.HandlerAction;
 ...
 *    desc   : Dialog 基类
 */
public class BaseDialog extends AppCompatDialog implements ContextAction, HandlerAction, ClickAction, AnimAction,
            ...
            if (mAnimations == AnimAction.NO_ANIM) {
                switch (mGravity) {
                    case Gravity.TOP:
                        ...
                        break;
                    case Gravity.BOTTOM:
                        mAnimations = AnimAction.ANIM_BOTTOM;
                        break;
                    case Gravity.LEFT:
