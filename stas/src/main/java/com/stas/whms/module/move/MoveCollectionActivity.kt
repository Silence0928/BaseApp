...
//            "DISC5060020000010091000210125104151120712305152071530815408155092123810-E0150                095440-12800J0000002Z999 0070380        00000000         "
        ...
        if (fromSource == REQ_SCANNER_GET) {
            if (response?.obj != null) {
                ...
                if (isCanSave(goodsInfo)) {
                    ...
                    mDataBinding.tableMoveCollection.addData(tempList, true)
                    handleTotalNum()
                } else {
    ...
    private fun saveData() {
        ...
        Thread {
            ...
            val result = StasHttpRequestUtil.saveMoveData(JSON.toJSONString(req))
...
//                    RouteJumpUtil.jumpToDocumentDetail()
        ...
        // 清除表格左右、底部边框线
        mDataBinding.tableMoveCollection.config.tableGridFormat = object: SimpleGridFormat(){
